...
React Native 需要的版本 [记录在此](https://github.com/facebook/react-native/blob/v0.70.7/.ruby-version)。你也可以在当前项目目录下的`.ruby-version`文件中找到所需的版本。（注：较早版本的 React Native 项目可能没有此文件）
